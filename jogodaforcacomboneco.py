...
def display_hangman(chances):
    ...
    # criar uma Lista de estágios da forca uma string do desenho do boneco
    stages = [  # estágio 6 (final).   A 1º contra barra é pq se quer o caracter a 2º é a contra barra 
                """
                   -------- 
                   |      |
                   |      O
